...
public class SettingFragment extends PreferenceFragmentCompat {
  ...
  public void setPreferenceScreen(PreferenceScreen preferenceScreen) {
    // SO:
    // https://stackoverflow.com/questions/18509369/android-how-to-get-remove-margin-padding-in-preference-screen
    // Bug: https://issuetracker.google.com/issues/111907042
    super.setPreferenceScreen(preferenceScreen);
    if (preferenceScreen != null) {
      int count = preferenceScreen.getPreferenceCount();
      for (int i = 0; i < count; i++) preferenceScreen.getPreference(i).setIconSpaceReserved(false);
    }
  }
